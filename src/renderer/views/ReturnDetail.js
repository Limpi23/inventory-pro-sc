        ...
        try {
            ...
            if (newStatus === 'procesada') {
                ...
                if (returnItems.length > 0) {
                    ...
                    await stockMovementService.createBatch(movements);
                }
            }
