...
const Invoices = () => {
    ...
    return (_jsxs("div", { className: "space-y-6 relative", children: [_jsxs("div", { className: "flex flex-col md:flex-row md:items-center md:justify-between", children: [_jsxs("div", { children: [_jsxs(Link, { to: "/ventas", className: "text-blue-600 hover:text-blue-800 flex items-center mb-2", children: [_jsx("i", { className: "fas fa-arrow-left mr-2" }), "Volver a Ventas"] }), _jsx("h1", { className: "text-2xl font-semibold", children: "Gesti\u00F3n de Cotizaciones" })] }), canCreateInvoices && (_jsxs(Link, { to: "/ventas/facturas/nueva", className: "mt-4 md:mt-0 px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors flex items-center justify-center", children: [_jsx("i", { className: "fas fa-plus mr-2" }), " Nueva Cotizaci\u00F3n"] }))] }), upcomingDueInvoices.length > 0 && showUpcomingAlert && (_jsxs("div", { className: "bg-amber-50 border-l-4 border-amber-400 p-4 rounded-md flex justify-between items-center", children: [_jsxs("div", { className: "flex items-center", children: [_jsx("i", { className: "fas fa-exclamation-triangle text-amber-500 mr-3 text-lg" }), _jsxs("div", { children: [_jsx("h3", { className: "font-semibold text-amber-800", children: "Cotizaciones pr\u00F3ximas a vencer" }), _jsx("p", { className: "text-amber-700", children: upcomingDueInvoices.length === 1
                                    ...
                                    : 'No hay cotizaciones registradas. ¡Crea tu primera cotización!' })] })) : (_jsxs(_Fragment, { children: [_jsx("div", { className: "overflow-x-auto", children: _jsxs("table", { className: "min-w-full divide-y divide-gray-200", children: [_jsx("thead", { className: "bg-gray-50", children: _jsxs("tr", { children: [_jsx("th", { className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "Cotizaci\u00F3n" }), _jsx("th", { className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "Cliente" }), _jsx("th", { className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "Fecha" }), _jsx("th", { className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "Total" }), _jsx("th", { className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "Estado" }), hasActionPermissions && (_jsx("th", { className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "Acciones" }))] }) }), _jsx("tbody", { className: "bg-white divide-y divide-gray-200", children: currentInvoices.map((invoice) => {
                                                ...
                                                return (_jsxs("tr", { className: `hover:bg-gray-50 ${isUpcomingDue ? 'bg-amber-50' : ''} cursor-pointer`, onClick: () => handleInvoiceRowClick(invoice), children: [_jsxs("td", { className: "px-6 py-4 whitespace-nowrap", children: [_jsx("div", { className: "font-medium text-gray-900", children: invoice.invoice_number }), _jsxs("div", { className: "text-sm text-gray-500", children: ["Almac\u00E9n: ", invoice.warehouse?.name] })] }), _jsxs("td", { className: "px-6 py-4 whitespace-nowrap", children: [_jsx("div", { className: "font-medium text-gray-900", children: invoice.customer?.name }), invoice.customer?.identification_number && (_jsxs("div", { className: "text-sm text-gray-500", children: ["ID: ", invoice.customer.identification_number] }))] }), _jsxs("td", { className: "px-6 py-4 whitespace-nowrap", children: [_jsx("div", { className: "text-sm text-gray-900", children: formatDate(invoice.invoice_date) }), invoice.due_date && (_jsxs("div", { className: `text-sm ${isUpcomingDue ? 'text-amber-600 font-medium' : 'text-gray-500'}`, children: ["Vence: ", formatDate(invoice.due_date), isUpcomingDue && (_jsx("span", { className: "ml-1 text-xs font-medium bg-amber-100 text-amber-800 px-1.5 py-0.5 rounded", children: daysRemaining === 1 ? '¡Mañana!' : `${daysRemaining} días` }))] }))] }), _jsx("td", { className: "px-6 py-4 whitespace-nowrap font-medium text-gray-900", children: formatCurrency(invoice.total_amount) }), _jsx("td", { className: "px-6 py-4 whitespace-nowrap", children: renderStatusBadge(invoice.status) }), hasActionPermissions && (_jsx("td", { className: "px-6 py-4 whitespace-nowrap text-sm text-gray-500", children: _jsxs(DropdownMenu, { children: [_jsx(DropdownMenuTrigger, { asChild: true, children: _jsxs(Button, { variant: "outline", size: "sm", className: "h-8 px-2", onClick: (e) => e.stopPropagation(), children: [_jsx("i", { className: "fas fa-ellipsis-v mr-2" }), "Acciones"] }) }), _jsxs(DropdownMenuContent, { align: "end", className: "min-w-[200px]", onClick: (e) => e.stopPropagation(), children: [showDetail && (_jsx(DropdownMenuItem, { asChild: true, children: _jsxs(Link, { to: `/ventas/facturas/${invoice.id}`, className: "flex items-center gap-2 w-full", onClick: (e) => e.stopPropagation(), children: [_jsx("i", { className: "fas fa-eye text-muted-foreground" }), _jsx("span", { children: "Ver detalle" })] }) })), showGenerateSale && (_jsx(DropdownMenuItem, { asChild: true, children: _jsxs(Link, { to: `/ventas/facturas/${invoice.id}?generar-venta=1`, className: "flex items-center gap-2 w-full", onClick: (e) => e.stopPropagation(), children: [_jsx("i", { className: "fas fa-cash-register text-emerald-600" }), _jsx("span", { children: "Generar venta" })] }) })), showEdit && (_jsx(DropdownMenuItem, { asChild: true, children: _jsxs(Link, { to: `/ventas/facturas/editar/${invoice.id}`, className: "flex items-center gap-2 w-full", onClick: (e) => e.stopPropagation(), children: [_jsx("i", { className: "fas fa-edit text-yellow-600" }), _jsx("span", { children: "Editar" })] }) })), shouldShowCancelSeparator && _jsx(DropdownMenuSeparator, {}), showCancel && (_jsxs(DropdownMenuItem, { onClick: (event) => {
                                                                                    event.stopPropagation();
                                                                                    handleDeleteInvoice(invoice.id);
                                                                                }, className: "text-red-600 focus:text-red-700", children: [_jsx("i", { className: "fas fa-ban" }), _jsx("span", { children: "Anular" })] })), shouldShowPrintSeparator && _jsx(DropdownMenuSeparator, {}), showPrint && (_jsx(DropdownMenuItem, { asChild: true, children: _jsxs(Link, { to: `/ventas/facturas/${invoice.id}`, className: "flex items-center gap-2 w-full", onClick: (e) => e.stopPropagation(), children: [_jsx("i", { className: "fas fa-print text-green-600" }), _jsx("span", { children: "Imprimir" })] }) }))] })] }) }))] }, invoice.id));
