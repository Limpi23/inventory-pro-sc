...
// (debug removed)
ReactDOM.createRoot(document.getElementById('root')).render(_jsx(React.StrictMode, { children: _jsx(AuthProvider, { children: _jsx(BranchProvider, { children: _jsx(Router, { children: _jsx(App, {}) }) }) }) }));
