...
const Layout = ({ children, onOpenConfig }) => {
    ...
    return (_jsxs("div", { className: "flex h-screen bg-background", children: [_jsxs("div", { className: cn("bg-card border-r transition-all duration-300 hidden lg:block", sidebarOpen ? 'w-64' : 'w-20'), children: [_jsx("div", { className: cn("p-4 flex items-center border-b", sidebarOpen ? "justify-between" : "justify-center"), children: sidebarOpen ? (_jsxs(_Fragment, { children: [_jsx("div", { className: "flex items-center", children: _jsx("h1", { className: "text-xl font-bold text-primary", children: "C.O.M.P.A" }) }), _jsx(Button, { variant: "ghost", size: "icon", onClick: () => setSidebarOpen(!sidebarOpen), title: "Contraer men\u00FA", children: _jsx("i", { className: "fas fa-chevron-left" }) })] })) : (_jsx(Button, { variant: "ghost", size: "icon", onClick: () => setSidebarOpen(!sidebarOpen), className: "w-12 h-12", title: "Expandir men\u00FA", children: _jsx("i", { className: "fas fa-bars text-xl" }) })) }), _jsx("nav", { className: "mt-6", children: _jsx("ul", { className: "space-y-1", children: filteredNavigationItems.map((item) => (_jsx(React.Fragment, { children: _jsx("li", { children: item.children ? (_jsxs("div", { children: [_jsxs("button", { onClick: () => toggleExpand(item.name), "aria-expanded": expandedItems[item.name.toLowerCase()], className: cn("flex items-center w-full py-3 px-4 transition-colors rounded-md", (location.pathname === item.path || location.pathname.startsWith(item.path + '/'))
